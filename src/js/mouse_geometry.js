...
// EXIT_COL_END 欄，否則帶子亮著卻點不到、或點得到卻沒亮。專案裡有兩套原點公式：
//
//   App.clientToPos（pttchrome.jsx）      滑鼠事件用，決定「點到第幾格」
//   TermView.convertMN2XYEx（term_view）  畫游標／輸入框用，多了 +10 與 +bbsViewMargin
//
// 兩者差幾個到十幾個像素。提示帶的幾何**只能**與 clientToPos 同源，所以把
// clientToPos 的欄位數學抽到這裡，讓 clientToPos 與帶子共用同一份實作。
